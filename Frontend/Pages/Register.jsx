...
const Register = () => {
  ...
  const handleRegister = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://sanjana-bhattarai-crimetrack-backend.onrender.com/api/auth/register", {
        method: "POST",
  ...
  const handleVerifyOtp = async (e) => {
    ...
    setLoading(true);
    try {
      const res = await fetch("https://sanjana-bhattarai-crimetrack-backend.onrender.com/api/auth/verify-otp", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
